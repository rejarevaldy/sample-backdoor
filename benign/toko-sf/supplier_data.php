...
<table width="900" border="0" cellpadding="2" cellspacing="1" class="table-border">
  <tr>
    <td colspan="2" align="right"><h1>DATA SUPPLIER</h1></td>
  </tr>
  <tr>
    <td colspan="2"><a href="?open=Supplier-Add" target="_self"><img src="images/btn_add_data.png" height="30" border="0" /></a></td>
  </tr>
  <tr>
    <td colspan="2">&nbsp;</td>
  </tr>
  <tr>
	...
	<table class="table-list" width="100%" border="0" cellspacing="1" cellpadding="2">
      <tr>
        ...
        <th width="272"><b>Nama Supplier </b></th>
        <th width="437"><b>Alamat</b></th>
        <td colspan="2" align="center" bgcolor="#CCCCCC"><b>Tools</b><b></b></td>
        </tr>
		<?php
		// Skrip menampilkan data dari database
		$mySql = "SELECT * FROM supplier ORDER BY kd_supplier ASC LIMIT $halaman, $baris";
      ...
      <tr bgcolor="<?php echo $warna; ?>">
        ...
        <td width="40" align="center"><a href="?open=Supplier-Delete&Kode=<?php echo $Kode; ?>" target="_self" alt="Delete Data" onclick="return confirm('ANDA YAKIN AKAN MENGHAPUS DATA SUPPLIER INI ... ?')">Delete</a></td>
      </tr>
      <?php } ?>
    </table></td>
  </tr>
