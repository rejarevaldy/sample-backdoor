...
if($dataBulan and $dataTahun) {
	if($dataBulan=="00") {
		// Filter tahun
		$filterSQL	= "AND LEFT(tgl_returbeli,4)='$dataTahun'";
		
		$infoBulan	= "";
	}
	else {
		// Filter bulan dan tahun
		$filterSQL = "AND MID(tgl_returbeli,6,2)='$dataBulan' AND LEFT(tgl_returbeli,4)='$dataTahun'";
...
<html>
<head>
<title>:: Laporan Data Retur Beli per Bulan/ Tahun - POS Toko Distributor</title>
<link href="../styles/styles_cetak.css" rel="stylesheet" type="text/css">
</head>
<body>
<h2>LAPORAN DATA RETUR PEMBELIAN PER BULAN/ TAHUN</h2>
...
<table class="table-list" width="900" border="0" cellspacing="1" cellpadding="2">
  <tr>
    ...
    <td width="96" bgcolor="#F5F5F5"><strong>No. Retur </strong></td>
    <td width="296" bgcolor="#F5F5F5"><strong>Supplier</strong></td>
    <td width="267" bgcolor="#F5F5F5"><strong>Keterangan </strong></td>
