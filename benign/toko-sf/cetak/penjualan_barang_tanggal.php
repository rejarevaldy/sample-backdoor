...
# Membaca data Tanggal dari URL
$dataTanggal 	= isset($_GET['tanggal']) ? $_GET['tanggal'] : "01-".date('m-Y');
...
<html>
<head>
<title>:: Laporan Penjualan Barang per Tanggal - POS Distributor</title>
<link href="../styles/styles_cetak.css" rel="stylesheet" type="text/css"></head>
<body>
<h2>LAPORAN  PENJUALAN BARANG PER TANGGAL</h2>
<table width="400" border="0"  class="table-list">
  <tr>
    <td colspan="3" bgcolor="#F5F5F5"><strong>KETERANGAN</strong></td>
  </tr>
  <tr>
    <td width="134"><strong>Tanggal </strong></td>
    <td width="15"><strong>:</strong></td>
    <td width="337"><strong><?php echo $dataTanggal; ?> </strong> </td>
  </tr>
</table>
<br />
