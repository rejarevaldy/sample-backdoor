...
<html>
<head>
<title> :: Laporan Retur Barang Beli per Periode - POS Inventory Toko</title>
<link href="../styles/styles_cetak.css" rel="stylesheet" type="text/css"></head>
<body>
<h2>LAPORAN RETUR PEMBELIAN BARANG PER PERIODE</h2>
...
<table class="table-list" width="900" border="0" cellspacing="1" cellpadding="2">
  <tr>
    ...
    <td width="131" bgcolor="#F5F5F5"><strong>Jenis</strong></td>
    <td width="117" bgcolor="#F5F5F5"><strong>Merek</strong></td>
  ...
  <?php
	...
	// Skrip menampilkan data Retur Pembelian per Item Barang dengan filter Periode
