...
<html>
<head>
<title>:: Data Supplier - POS Toko & Distributor</title>
...
<table class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  <tr>
    ...
    <td width="213" bgcolor="#F5F5F5"><strong>Nama Supplier </strong></td>
    <td width="388" bgcolor="#F5F5F5"><strong>Alamat Lengkap </strong></td>
    <td width="138" bgcolor="#F5F5F5"><strong>No. Telepon </strong></td>
  </tr>
  <?php
  // Skrip menampilkan data Supplier ke layar
