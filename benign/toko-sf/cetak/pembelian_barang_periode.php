...
if($_GET) {
	$filterData = $filterSQL." AND ( tgl_pembelian BETWEEN '".InggrisTgl($tglAwal)."' AND '".InggrisTgl($tglAkhir)."')";
}
else {
...
<html>
<head>
<title> :: Laporan Pembelian Barang per Periode </title>
<link href="../styles/styles_cetak.css" rel="stylesheet" type="text/css"></head>
<body>
<h2>LAPORAN TRAFIK PEMBELIAN BARANG PER PERIODE</h2>
...
<table class="table-list" width="900" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <td width="85" bgcolor="#F5F5F5"><strong>No. Faktur </strong></td>
    <td width="56" bgcolor="#F5F5F5"><strong>Kode</strong></td>
    <td width="333" bgcolor="#F5F5F5"><strong>Nama Barang </strong></td>
    <td width="95" align="right" bgcolor="#F5F5F5"><strong>PPN/PPH (Rp) </strong></td>
    <td width="116" align="right" bgcolor="#F5F5F5"><strong>Hrg. Beli (Rp) </strong></td>
    <td width="48" align="right" bgcolor="#F5F5F5"><strong>Jumlah</strong></td>
    <td width="111" align="right" bgcolor="#F5F5F5"><strong>Hrg. Total (Rp) </strong></td>
  </tr>
  <?php
  	// deklarasi variabel
	$totalHarga	= 0;
