...
if (isset($_POST['btnTampil'])) {
	...
	$filterSQL = "AND ( tgl_penjualan BETWEEN '".InggrisTgl($tglAwal)."' AND '".InggrisTgl($tglAkhir)."')";
}
else {
...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self">
  <table width="500" border="0"  class="table-list">
    ...
    <tr>
      ...
      <td width="391"><input name="txtTglAwal" type="text" class="tcal" value="<?php echo $tglAwal; ?>" size="18" />
        s/d
      <input name="txtTglAkhir" type="text" class="tcal" value="<?php echo $tglAkhir; ?>" size="18" /></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
...
<table class="table-list" width="900" border="0" cellspacing="1" cellpadding="2">
  ...
  <?php
	...
	// Skrip menampilkan data Barang dari tiap Transaksi Penjualan, dilengkapi filter Periode Transaksi
