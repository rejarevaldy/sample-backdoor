...
if (isset($_POST['btnCetak'])) {
	// Buka file
	echo "<script>";
	echo "window.open('cetak/returjual_periode.php?tglAwal=$tglAwal&tglAkhir=$tglAkhir')";
	echo "</script>";
}
...
?>
<h2>LAPORAN RETUR PENJUALAN PER PERIODE</h2>
...
<table class="table-list" width="900" border="0" cellspacing="1" cellpadding="2">
  ...
  <?php
	// Skrip untuk menampilkan data Retur Penjualan dengan Filter Periode
  ...
  <tr>
	...
	for ($h = 1; $h <= $maksData; $h++) {
		...
		echo " <a href='?open=Laporan-Returjual-Periode&hal=$list[$h]&tglAwal=$tglAwal&tglAkhir=$tglAkhir'>$h</a> ";
	}
	?>
    </strong></td>
  </tr>
...
<a href="cetak/returjual_periode.php?tglAwal=<?php echo $tglAwal; ?>&tglAkhir=<?php echo $tglAkhir; ?>" target="_blank"><img src="images/btn_print2.png" height="18" border="0" title="Cetak ke Format HTML"/></a>
<?php 
// Penutup Hak Akses
}
else {
