...
if (isset($_POST['btnCetak'])) {
	// Buka file
	echo "<script>";
	echo "window.open('cetak/penjualan_tahun.php?tahun=$dataTahun', width=330,height=330,left=100, top=25)";
	echo "</script>";
}
...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self">
  <table width="500" border="0" class="table-list">
    ...
    <tr>
      <td width="101"><strong>Periode Tahun </strong></td>
...
<table class="table-list" width="900" border="0" cellspacing="1" cellpadding="2">
  ...
  <?php
	...
	// Skrip untuk menampilkan Transaksi Penjualan dengan Filter Tahun
   ...
   <tr bgcolor="<?php echo $warna; ?>">
    ...
    <td width="40" align="center"><a href="cetak/penjualan_cetak.php?noNota=<?php echo $noNota; ?>" target="_blank">Cetak</a></td>
    <td width="40" align="center"><a href="penjualan/penjualan_nota.php?noNota=<?php echo $noNota; ?>" target="_blank">Nota</a></td>
  </tr>
  <?php } ?>
  <tr>
  ...
  <tr>
	...
	for ($h = 1; $h <= $maksData; $h++) {
		...
		echo " <a href='?open=Laporan-Penjualan-Tahun&hal=$list[$h]&tahun=$dataTahun'>$h</a> ";
	}
	?>
    </strong></td>
  </tr>
...
<a href="cetak/penjualan_tahun.php?tahun=<?php echo $dataTahun; ?>" target="_blank"><img src="images/btn_print2.png" height="18" border="0" title="Cetak ke Format HTML"/></a>
<?php 
// Penutup Hak Akses
}
else {
