  ...
  <tr>
	...
	<table class="table-list" width="100%" border="0" cellspacing="1" cellpadding="2">
      <tr>
        ...
        <td width="104" bgcolor="#CCCCCC"><strong>Barcode/ PLU</strong></td>
        <td width="383" bgcolor="#CCCCCC"><strong>Nama Barang </strong></td>
        <td width="158" bgcolor="#CCCCCC"><strong>Jenis</strong></td>
