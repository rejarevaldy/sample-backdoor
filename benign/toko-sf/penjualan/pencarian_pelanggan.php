...
<table width="900" border="0" cellpadding="2" cellspacing="1" class="table-border">
  ...
  <tr>
    <td colspan="2"><table width="100%" border="0"  class="table-list">
      ...
      <tr>
        <td width="132"><strong>Cari Nama </strong></td>
  ...
  <tr>
	...
	<table class="table-list" width="100%" border="0" cellspacing="1" cellpadding="2">
      <tr>
        ...
        <td width="269" bgcolor="#CCCCCC"><strong>Nama Barang </strong></td>
        <td width="284" bgcolor="#CCCCCC"><strong>Alamat</strong></td>
        <td width="156" bgcolor="#CCCCCC"><strong>No. Telepon </strong></td>
        <td width="81" align="right" bgcolor="#CCCCCC"><strong>Level Harga </strong></td>
      </tr>
      <?php
	...
	?>
      <tr bgcolor="<?php echo $warna; ?>">
        ...
        <td><a href="#" onClick="window.opener.document.getElementById('idKodePlg').value = '<?php echo $myData['kd_pelanggan']; ?>';
								 window.opener.document.getElementById('idNamaPlg').value = '<?php echo $myData['nm_pelanggan']; ?>';
								 window.close();"><b><?php echo $myData['nm_pelanggan']; ?></b></a></td>
        <td><?php echo $myData['alamat']; ?></td>
        <td><?php echo $myData['no_telepon']; ?></td>
        <td align="right" bgcolor="<?php echo $warna; ?>"><?php echo $myData['level_harga']; ?></td>
      </tr>
      <?php } ?>
      <tr>
