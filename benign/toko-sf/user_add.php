...
$dataKontrolStok 	= isset($_POST['rbKontrolStok']) ? $_POST['rbKontrolStok'] : 'No';
...
$dataBayarBeli 		= isset($_POST['rbBayarBeli']) ? $_POST['rbBayarBeli'] : 'No';
	if($dataBayarBeli =="No") { $pilihBayarBeliN = "checked"; $pilihBayarBeliY = ""; } else { $pilihBayarBeliN = ""; $pilihBayarBeliY = "checked"; }
	
$dataBayarJual 		= isset($_POST['rbBayarJual']) ? $_POST['rbBayarJual'] : 'No';
...
$dataExportPelanggan 		= isset($_POST['rbExportPelanggan']) ? $_POST['rbExportPelanggan'] : 'No';
...
$dataImportPelanggan 		= isset($_POST['rbImportPelanggan']) ? $_POST['rbImportPelanggan'] : 'No';
...
$lapBarangJenis 		= isset($_POST['rbLapBarangJenis']) ? $_POST['rbLapBarangJenis'] : 'No';
...
$lapBarangMinimal 		= isset($_POST['rbLapBarangMinimal']) ? $_POST['rbLapBarangMinimal'] : 'No';
...
$lapBarangMaksimal 		= isset($_POST['rbLapBarangMaksimal']) ? $_POST['rbLapBarangMaksimal'] : 'No';
...
$lapPenjualanTanggal 		= isset($_POST['rbLapPenjualanTanggal']) ? $_POST['rbLapPenjualanTanggal'] : 'No';
...
$lapPenjualanPelanggan 		= isset($_POST['rbLapPenjualanPelanggan']) ? $_POST['rbLapPenjualanPelanggan'] : 'No';
...
$lapPenjualanBarangTanggal 		= isset($_POST['rbLapPenjualanBarangTanggal']) ? $_POST['rbLapPenjualanBarangTanggal'] : 'No';
...
$lapPenjualanBarangPelanggan 		= isset($_POST['rbLapPenjualanBarangPelanggan']) ? $_POST['rbLapPenjualanBarangPelanggan'] : 'No';
...
$lapLabarugiPeriode 		= isset($_POST['rbLapLabarugiPeriode']) ? $_POST['rbLapLabarugiPeriode'] : 'No';
...
$lapLabarugiBulan 		= isset($_POST['rbLapLabarugiBulan']) ? $_POST['rbLapLabarugiBulan'] : 'No';
...
$lapReturJualPeriode 		= isset($_POST['rbLapReturJualPeriode']) ? $_POST['rbLapReturJualPeriode'] : 'No';
...
$lapReturJualBulan 		= isset($_POST['rbLapReturJualBulan']) ? $_POST['rbLapReturJualBulan'] : 'No';
...
$lapReturJualBarangPeriode 		= isset($_POST['rbLapReturJualBarangPeriode']) ? $_POST['rbLapReturJualBarangPeriode'] : 'No';
...
$lapReturJualBarangBulan 		= isset($_POST['rbLapReturJualBarangBulan']) ? $_POST['rbLapReturJualBarangBulan'] : 'No';
...
$lapReturJualRekapPeriode 		= isset($_POST['rbLapReturJualRekapPeriode']) ? $_POST['rbLapReturJualRekapPeriode'] : 'No';
...
$lapReturJualRekapBulan 		= isset($_POST['rbLapReturJualRekapBulan']) ? $_POST['rbLapReturJualRekapBulan'] : 'No';
...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self">
  <table width="100%" class="table-list" border="0" cellspacing="1" cellpadding="4">
    ...
    <tr>
      ...
      <td width="5"><b>:</b></td>
      <td width="984"> <input name="textfield" type="text" value="<?php echo $dataKode; ?>" size="10" maxlength="6" readonly="readonly"/></td>
    </tr>
    <tr>
      <td><b>Nama User </b></td>
      <td><b>:</b></td>
    ...
    <tr>
      ...
      <td><b>:</b></td>
      <td><input name="rbKontrolStok" type="radio" value="No" <?php echo $pilihKontrolStokN; ?> />No
 	 	<input name="rbKontrolStok" type="radio" value="Yes" <?php echo $pilihKontrolStokY; ?>/>Yes </td>
    </tr>
    <tr>
      <td><strong>Pencarian Barang </strong></td>
      <td><b>:</b></td>
      <td><input name="rbCariBarang" type="radio" value="No" <?php echo $pilihCariBarangN; ?> />No
          <input name="rbCariBarang" type="radio" value="Yes" <?php echo $pilihCariBarangY; ?>/> Yes </td>
    </tr>
    <tr>
